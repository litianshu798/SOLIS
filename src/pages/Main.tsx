...
export default function Main() {
  ...
  return (
    <div className="h-full flex flex-col bg-[#f5f2ed]" style={{ animation: 'fadeIn 0.5s ease-out' }}>
      {/* Content area */}
      ...
      {/* Bottom Tab Bar */}
      <div className="shrink-0 bg-white/80 backdrop-blur-xl border-t border-stone-200/60">
        <div className="flex items-center justify-around max-w-md mx-auto px-4 py-1.5 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
          {tabs.map((tab) => {
